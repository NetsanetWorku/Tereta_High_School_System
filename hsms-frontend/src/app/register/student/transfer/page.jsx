...
export default function TransferStudentRegistration() {
  ...
  return (
    <>
      <Navbar />
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-blue-100 flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8 pt-24">
        ...
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-gray-600">
            For students transferring to Tereta High School from another high school
          </p>
            ...
            <div className="border-b border-gray-200 pb-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    required
                    className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                    placeholder="Name of your previous high school"
                  />
                </div>
                ...
                <div>
                  ...
                  <select
                    ...
                    value={formData.last_attendance_year}
                    onChange={handleChange}
                    required
                    className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                  >
              ...
              <div className="mt-6">
                ...
                <textarea
                  ...
                  rows="3"
                  className="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-blue-500 focus:border-blue-500 sm:text-sm"
                  placeholder="Please explain why you are transferring schools"
                />
              </div>
            </div>
