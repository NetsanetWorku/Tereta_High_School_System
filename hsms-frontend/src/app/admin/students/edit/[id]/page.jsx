...
export default function EditStudentPage() {
  ...
  const fetchStudent = async () => {
    try {
      ...
      const response = await studentAPI.getById(params.id)
      ...
      const name = studentData.user?.name || studentData.name || ''
      const email = studentData.user?.email || studentData.email || ''
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await studentAPI.update(params.id, formData)
